...
@section('content')
    ...
    <section>
        <div class="products-brand" style="padding-top: 3rem;">
            ...
            <input type="hidden" id="wishlist_productname{{ $product->ma_dr }}" value="{{ $product->ten_dr }}"
                                ...
                                <div class="col-inner text-left">
                                    ...
                                    <div class="product-price-container is-xlarge">
                                        <span class="woocommerce-Price-amount amount">
                                            ...
                                            @if (isset($product->coupon_details) && $product->coupon_details->phantram_km > 0  && $product->coupon_details->so_luong > 0)
                                                <span
                                                    style="text-decoration-line:line-through;text-decoration-color:black">{{ number_format($product->gia) . ' VNĐ' }}</span>
                                                <span
                                                    class="price">{{ number_format($product->gia - ($product->gia * $product->coupon_details->phantram_km) / 100) . ' VNĐ' }}</span>
                                    ...
                                    <div class="quantity">
                                        ...
                                        <input type="number" name="qty" id=""
                                            class="cart_detail cart_product_qty_{{ $product->ma_dr }}" value="1"
                                            min="1" max="{{ $product->sl_ton }}">
                                    ...
                                    @else
                                        ...
                                        ?>
                                        <button style="cursor: pointer;" data-check="{{ $check }}" type="submit"
                                    ...
                                    <div class="note">
                                        <p style="font-size: 24px;"><b>Tình
                                                Trạng:</b>{{ $product->sl_ton == 0 ? 'Hết hàng' : 'Còn hàng' }}</p>
