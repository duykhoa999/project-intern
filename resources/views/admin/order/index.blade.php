...
<div class="table-agile-info">
    <div class="panel panel-default">
            ...
            <form style="float: right" method="get" action="{{route('admin.order.index')}}" id="filterOrder">
                <div class="group-input f-r">
                    <select name="trang_thai_dh" id="trang-thai-dong-hang">
                        ...
                        <option value="0" <?php if (isset($arr_filter['trang_thai_dh']) && $arr_filter['trang_thai_dh'] == 0) echo 'selected'; ?>>Chưa duyệt
                        </option>
                        <option value="1" <?php if (isset($arr_filter['trang_thai_dh']) && $arr_filter['trang_thai_dh'] == 1) echo 'selected'; ?>>Đã duyệt
                        </option>
                        <option value="2" <?php if (isset($arr_filter['trang_thai_dh']) && $arr_filter['trang_thai_dh'] == 2) echo 'selected'; ?>>Đã phân công nhân viên
                        </option>
                        <option value="3" <?php if (isset($arr_filter['trang_thai_dh']) && $arr_filter['trang_thai_dh'] == 3) echo 'selected'; ?>>Hoàn tất
                        </option>
                        <option value="4" <?php if (isset($arr_filter['trang_thai_dh']) && $arr_filter['trang_thai_dh'] == 4) echo 'selected'; ?>>Đã hủy
                        </option>
                    </select>
                </div>
        ...
        <div id="setNVModal" class="modal modal-default fade in" data-backdrop="static" data-keyboard="false" style="display: none; padding-right: 17px;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="" id="editSetNVForm" class="form-horizontal" style="text-align: center;">
                        @csrf
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="box-body">
                            ...
                            <div class="box-footer">
                                <div class="row">
                                    <div class="col-md-8 text-center">
                                        ...
                                        <button type="button" id="editSetNVFormCancel" class="btn btn-default">Close</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    $('form#editSetNVForm').submit(function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status == true) {
                    var html = '';
                    html += '<li style="font-weight: bold;font-size: 18px ">' + data.message + '</li>';
